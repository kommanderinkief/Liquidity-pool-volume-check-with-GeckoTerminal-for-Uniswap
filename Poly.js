...
const bot = new TelegramBot('6096061104:AAGbZS5hXno-CeENKFs1wLHM1wv8mQ46NFg');


async function getPools(pageNO) {
  const response = await axios.get(
    `https://app.geckoterminal.com/api/p1/polygon_pos/pools?include=dex,dex.network,dex.network.network_metric,tokens&page=${pageNO}&include_network_metrics=true`
  );
